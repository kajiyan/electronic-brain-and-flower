...
/******/ 	__webpack_require__.p = "//localhost:3031/";
/******/
	...
	/* WEBPACK VAR INJECTION */(function(jQuery) {(function(window, document, $) {
	  ...
	  return $(window).load(function() {
	    ...
	    sn.tf.setup(function() {
	      ...
	      return $.when(sn.stage.setup()).then((function(_this) {
	        return function() {
	    ...
	    Stage.prototype.setup = function(skip) {
	      ...
	      return $.Deferred((function(_this) {
	        return function(defer) {
	          ...
	          _this._getElements();
	          _this._events();
	          _this.$els.textQuantize.quantize().then(function() {
	            _this.$els.textQuantize.removeClass("is-invisibility");
	            return onDone();
	          });
	          return onDone();
	        };
