...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4), __webpack_require__(8), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
	...
	module.exports = function(sn, $, _) {
	  ...
	  return ReadLightValue = (function(_super) {
	    ...
	    ReadLightValue.prototype._readLightValueHandler = function(model) {
	      ...
	      to = {
	        opacity: sn.tf.valueMap(parseInt(this.model.get("readLightValue")), 0, 255, 0, 1.0, false)
	      };
	      return this.$el.css(to);
	    };
