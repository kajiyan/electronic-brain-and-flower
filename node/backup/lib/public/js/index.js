...
/******/ 	__webpack_require__.p = "//localhost:3030/";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery, _) {(function(window, document, $) {
	  ...
	  sn.router = (function() {
	    var Router;
	    Router = __webpack_require__(3)(sn, $, _);
	    return new Router();
	  })();
	  return $(window).load(function() {
	    ...
	    sn.clock = __webpack_require__(2)(sn);
	    sn.tf.setup(function() {
	      common.stage.setWindowResizedEnabled(false);
	      common.stage.windowResized();
	      return $.when(sn.router.setup(), sn.stage.setup(), sn.clock.setup()).then((function(_this) {
	        return function() {
	          $("body").removeClass("is-invisibility");
	          return console.log("- SETUP SCRIPT -");
	        };
	      })(this));
	    });
	    sn.tf.update(function() {
	      return sn.clock.update();
	    });
	    sn.tf.draw(function() {
	      return sn.clock.draw();
	    });
	    sn.tf.hover(function() {});
	    sn.tf.keyPressed(function(key) {});
	    sn.tf.keyReleased(function(key) {});
	    sn.tf.click(function() {});
	    sn.tf.pointerDown(function() {});
	    sn.tf.pointerEnter(function() {});
	    sn.tf.pointerLeave(function() {});
	    sn.tf.pointerMoved(function() {});
	    sn.tf.pointerOut(function() {});
	    sn.tf.pointerOver(function() {});
	    sn.tf.pointerUp(function() {});
	    sn.tf.windowScroll(function(top) {
	      return sn.stage.windowScroll(top);
	    });
	    sn.tf.windowResized(function(width, height) {
	      common.stage.windowResized();
	      return sn.stage.windowResized(width, height);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn) {
	  ...
	  Stage = (function(_super) {
	    ...
	    Stage.prototype.windowResized = function(width, height) {
	      return this.windowHeight = height;
	    };
	    ...
	    Stage.prototype._events = function() {
	      ...
	      this.$els.siteIndexAfford.on({
	        "touchstart mousedown MSPointerDown pointerdown": (function(_this) {
	          return function(e) {
	            e.preventDefault();
	            return _this.animate.indexIn(_this.$els.siteMenu, 200);
	          };
	        })(this)
	      });
	      return this.$els.sideMenuClose.on({
	        "touchstart mousedown MSPointerDown pointerdown": (function(_this) {
	          return function(e) {
	            e.preventDefault();
	            return _this.animate.indexOut(_this.$els.siteMenu, 200);
	          };
	        })(this)
	      });
	    };
	    ...
	    Stage.prototype._getElements = function() {
	      this.$els = {};
	      this.$els.textQuantize = $(".js-text-quantize");
	      this.$els.siteHeader = $("#js-site-header");
	      this.$els.siteIndexAfford = $(".js-site-index-afford");
	      this.$els.siteMenu = $("#js-side-menu");
	      this.$els.sideMenuClose = $("#js-side-menu-close");
	      return this.$els;
	    };
	          ...
	          return function($el, direction) {
	            return $.Deferred(function(defer) {
	              ...
	              if (sn.transitionEnabled) {
	                e = "ease";
	                return $el.removeClass("is-hidden").stop().transition(to, d, e, function() {
	                  return onDone();
	                });
	              } else {
	                e = "swing";
	                return $el.removeClass("is-hidden").stop().animate(to, d, e, function() {
	                  return onDone();
	                });
	              }
	            }).promise();
	        ...
	        indexOut: (function(_this) {
	          return function($el, direction) {
	            return $.Deferred(function(defer) {
	              ...
	              if (sn.transitionEnabled) {
	                e = "ease";
	                return $el.stop().transition(to, d, e, function() {
	                  return onDone();
	                });
	              } else {
	                e = "swing";
	                return $el.stop().animate(to, d, e, function() {
	                  return onDone();
	                });
	              }
	            }).promise();
	...
	module.exports = function(sn) {
	  ...
	  Clock = (function(_super) {
	    ...
	    function Clock() {
	      ...
	      this.controlEnabled = false;
	      this.now = 0;
	      this.monthLabel = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
	      this.weekLabel = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
	      this.timesOfDay = "";
	      this;
	    }
	
	    Clock.prototype.setup = function(skip) {
	      if (skip == null) {
	        skip = false;
	      }
	      return $.Deferred((function(_this) {
	    ...
	    Clock.prototype.update = function() {
	      var d, date, hours, min, mon, s, w, y;
	      date = new Date();
	      if (this.now !== date.getSeconds()) {
	        ...
	        w = date.getDay();
	        return this.timesOfDay = this.weekLabel[w] + " " + d + " " + this.monthLabel[mon] + " " + y + " at " + hours + ":" + min + ":" + s;
	      }
	    };
	
	    Clock.prototype.draw = function() {
	      return this.$els.coverClock.text(this.timesOfDay);
	    };
	
	    Clock.prototype.hover = function() {};
	
	    Clock.prototype.keyPressed = function(key) {};
	
	    Clock.prototype.keyReleased = function(key) {};
	
	    Clock.prototype.click = function() {};
	
	    Clock.prototype.pointerDown = function() {};
	
	    Clock.prototype.pointerEnter = function() {};
	
	    Clock.prototype.pointerLeave = function() {};
	
	    Clock.prototype.pointerMoved = function() {};
	
	    Clock.prototype.pointerOut = function() {};
	
	    Clock.prototype.pointerOver = function() {};
	
	    Clock.prototype.pointerUp = function() {};
	
	    Clock.prototype.windowScroll = function(top) {};
	
	    Clock.prototype.windowResized = function(width, height) {};
	
	    Clock.prototype.animate = function() {};
	
	    Clock.prototype.exit = function() {
	      return $.Deferred((function(_this) {
	        return function(defer) {
	          var onDone;
	          onDone = function() {
	    ...
	    Clock.prototype._events = function() {
	      return console.log("Clock -> events");
	    };
	
	    Clock.prototype._getElements = function() {
	      this.$els = {};
	      this.$els.coverClock = $("#js-clock");
	      return this.$els;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  return sn.Router = (function(_super) {
	    ...
	    Router.prototype.routes = {
	      "client(/)(:roomid)": function() {
	        var client;
	        client = __webpack_require__(9)(sn, $, _);
	        return client.setup();
	      },
	      "bridge(/)": function() {
	        var bridge;
	        bridge = __webpack_require__(10)(sn, $, _);
	        return bridge.setup();
	      },
	      "*default": function() {
	        var viewer;
	        viewer = __webpack_require__(11)(sn, $, _);
	        return viewer.setup();
	      }
	    };
	    ...
	    Router.prototype.request = function(param) {};
	  ...
	  Client = (function() {
	    function Client(options) {
	      ...
	      sn.__client__.models = {
	        socket: (function() {
	          var Socket;
	          Socket = __webpack_require__(13)(sn, $, _);
	          return new Socket();
	        })(),
	        devicemotion: (function() {
	          var Devicemotion;
	          Devicemotion = __webpack_require__(14)(sn, $, _);
	          return new Devicemotion();
	        })(),
	        deviceOrientation: (function() {
	          var DeviceOrientation;
	          DeviceOrientation = __webpack_require__(15)(sn, $, _);
	          return new DeviceOrientation();
	        })(),
	        deviceSensor: (function() {
	          var DeviceSensor;
	          DeviceSensor = __webpack_require__(16)(sn, $, _);
	          return new DeviceSensor();
	        })(),
	        image: (function() {
	          var Image;
	          Image = __webpack_require__(17)(sn, $, _);
	          return new Image();
	        })(),
	        resize: (function() {
	          var Resize;
	          Resize = __webpack_require__(18)(sn, $, _);
	          return new Resize();
	        })(),
	        context: (function() {
	          var Context;
	          Context = __webpack_require__(19)(sn, $, _);
	          return new Context();
	        })(),
	        visual: (function() {
	          var Visual;
	          Visual = __webpack_require__(20)(sn, $, _);
	          return new Visual();
	        })()
	      };
	      sn.__client__.views = {
	        image: (function() {
	          var Image;
	          Image = __webpack_require__(21)(sn, $, _);
	          return new Image();
	        })(),
	        select: (function() {
	          var Select;
	          Select = __webpack_require__(22)(sn, $, _);
	          return new Select();
	        })(),
	        readText: (function() {
	          var ReadText;
	          ReadText = __webpack_require__(23)(sn, $, _);
	          return new ReadText();
	        })(),
	        readLightValue: (function() {
	          var ReadLightValue;
	          ReadLightValue = __webpack_require__(24)(sn, $, _);
	  ...
	  Viewer = (function() {
	    function Viewer(options) {
	      ...
	      sn.__viewer__.models = {
	        image: (function() {
	          var Image;
	          return Image = __webpack_require__(25)(sn, $, _);
	        })(),
	        mode: (function() {
	          var Mode;
	          Mode = __webpack_require__(26)(sn, $, _);
	          return new Mode();
	        })(),
	        room: (function() {
	          var Room;
	          Room = __webpack_require__(27)(sn, $, _);
	          return new Room();
	        })(),
	        socket: (function() {
	          var Socket;
	          Socket = __webpack_require__(28)(sn, $, _);
	          return new Socket();
	        })(),
	        context: (function() {
	          var Context;
	          Context = __webpack_require__(29)(sn, $, _);
	          return new Context();
	        })()
	      };
	      ...
	      sn.__viewer__.views = {
	        header: (function() {
	          var Header;
	          Header = __webpack_require__(31)(sn, $, _);
	          return new Header();
	        })(),
	        footer: (function() {
	          var Footer;
	          Footer = __webpack_require__(32)(sn, $, _);
	          return new Footer();
	        })(),
	        image: (function() {
	          var Image;
	          return Image = __webpack_require__(33)(sn, $, _);
	        })(),
	        images: (function() {
	          var Images;
	          Images = __webpack_require__(34)(sn, $, _);
	          return new Images();
	        })()
	      };
	    }
	    ...
	    Viewer.prototype.setup = function() {
	      var key, _base, _base1, _base2, _results;
	      console.log("Viewer -> setup");
	      for (key in sn.__viewer__.models) {
	        if (typeof (_base = sn.__viewer__.models[key]).setup === "function") {
	          _base.setup();
	        }
	      }
	      for (key in sn.__viewer__.collections) {
	        if (typeof (_base1 = sn.__viewer__.collections[key]).setup === "function") {
	          _base1.setup();
	        }
	      }
	      _results = [];
	      for (key in sn.__viewer__.views) {
	        _results.push(typeof (_base2 = sn.__viewer__.views[key]).setup === "function" ? _base2.setup() : void 0);
	      }
	      return _results;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Socket = (function(_super) {
	    ...
	    Socket.prototype._events = function() {
	      console.log("Socket -> _events");
	      this.listenTo(sn.__client__.models.image, "resize", this._imageResizeHandler);
	      return this.listenTo(sn.__client__.models.deviceSensor, "throw", this._devicesensorThrowHandler);
	    };
	    ...
	    Socket.prototype.connect = function() {
	      ...
	      socket = io.connect("http://" + this._setting.HOST + ":" + this._setting.PORT + "/client");
	      socket.on("connect", this._connectHandler.bind(this));
	      ...
	      socket.on("readText", this._readText.bind(this));
	      socket.on("readLightValue", this._readLightValue.bind(this));
	      return this._socket = socket;
	    };
	
	    Socket.prototype._readText = function(data) {
	      console.log("Socket -> _readText");
	      return this.set("readText", data.text);
	    };
	
	    Socket.prototype._readLightValue = function(data) {
	      console.log("Socket -> _readLightValue");
	      return this.set("readLightValue", data.value);
	    };
	    ...
	    Socket.prototype._imageResizeHandler = function(model, data) {
	      var height, width;
	      ...
	      return this._socket.emit("post", {
	        data: data,
	        width: width,
	        height: height,
	        userInfo: ""
	      }, function(err, id) {
	        return sn.__client__.models.image.set("id", id);
	      });
	    };
	
	    Socket.prototype._devicesensorThrowHandler = function(model) {
	      ...
	      this._socket.emit("trigger", {
	        id: sn.__client__.models.image.get("id")
	      });
	      return sn.__client__.models.image.clear();
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  var DeviceMotion;
	  return DeviceMotion = (function(_super) {
	    __extends(DeviceMotion, _super);
	
	    function DeviceMotion() {
	      this._devicemotionHandler = __bind(this._devicemotionHandler, this);
	      console.log("DeviceMotion -> Constructor");
	      DeviceMotion.__super__.constructor.apply(this, arguments);
	      this.THRESHOLD = 1.5 * 9.8;
	    }
	
	    DeviceMotion.prototype.initialize = function() {
	      return console.log("DeviceMotion -> initialize");
	    };
	    ...
	    DeviceMotion.prototype.start = function() {
	      ...
	      return window.addEventListener("devicemotion", this._devicemotionHandler, false);
	    };
	
	    DeviceMotion.prototype._devicemotionHandler = function(e) {
	      var acceleration, maxKey, maxVal, thres, x, y, z;
	      console.log("DeviceMotion -> _devicemotionHandler");
	      setTimeout((function(_this) {
	        return function() {
	          _this.trigger("devicemotion", _this);
	          _this.unset("throwable");
	          return window.removeEventListener("devicemotion", _this._devicemotionHandler, false);
	        };
	      })(this), 4000);
	      return;
	      ...
	      if (x > thres || y > thres || z > thres) {
	        if (!this.has("maxKey")) {
	          ...
	          if (this.get("maxVal" < maxVal)) {
	            return this.set("maxVal", maxVal);
	          } else {
	            this.trigger("devicemotion", this);
	            this.unset("throwable");
	            return window.removeEventListener("devicemotion", this._devicemotionHandler, false);
	          }
	        }
	      } else {
	        this.unset("maxKey");
	        return this.unset("maxVal");
	      }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  var DeviceOrientation;
	  return DeviceOrientation = (function(_super) {
	    __extends(DeviceOrientation, _super);
	
	    function DeviceOrientation() {
	      console.log("DeviceOrientation -> Constructor");
	      DeviceOrientation.__super__.constructor.apply(this, arguments);
	    }
	
	    DeviceOrientation.prototype.initialize = function() {
	      return console.log("DeviceOrientation -> initialize");
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  var DeviceSensor;
	  return DeviceSensor = (function(_super) {
	    __extends(DeviceSensor, _super);
	
	    function DeviceSensor() {
	      console.log("DeviceSensor -> Constructor");
	      DeviceSensor.__super__.constructor.apply(this, arguments);
	    }
	
	    DeviceSensor.prototype.initialize = function() {
	      return console.log("DeviceSensor -> initialize");
	    };
	
	    DeviceSensor.prototype.setup = function() {
	      console.log("DeviceSensor -> Setup");
	      return this._events();
	    };
	
	    DeviceSensor.prototype._events = function() {
	      console.log("DeviceSensor -> _events");
	      this.listenTo(sn.__client__.models.image, "select", this._selectHandler);
	      this.listenTo(sn.__client__.models.image, "post", this._postHandler);
	      return this.listenTo(sn.__client__.models.devicemotion, "devicemotion", this._devicemotionHandler);
	    };
	
	    DeviceSensor.prototype._selectHandler = function() {
	      console.log("DeviceSensor -> _selectHandler");
	      return sn.__client__.models.devicemotion.start();
	    };
	
	    DeviceSensor.prototype._postHandler = function() {
	      console.log("DeviceSensor -> _postHandler");
	      return sn.__client__.models.devicemotion.set("throwable", true);
	    };
	
	    DeviceSensor.prototype._devicemotionHandler = function() {
	      console.log("DeviceSensor -> _devicemotionHandler");
	      return setTimeout((function(_this) {
	        return function() {
	          return _this.trigger("throw", _this);
	        };
	      })(this), 200);
	    };
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Image = (function(_super) {
	    ...
	    Image.prototype.initialize = function() {
	      ...
	      return this.on("change:id", this._changeIdHandler);
	    };
	
	    Image.prototype._changeFileHandler = function(model, file) {
	      console.log("Model | Image -> _changeFileHandler");
	      if (file) {
	        return this.trigger("select", this, file);
	      } else {
	        return this.trigger("clear", this);
	      }
	    };
	
	    Image.prototype._changeDataHandler = function(model, data) {
	      console.log("Model | Image -> _changeDataHandler");
	      if (data) {
	        return this.trigger("resize", this, data);
	      }
	    };
	
	    Image.prototype._changeIdHandler = function(model, id) {
	      console.log("Model | Image -> _changeIdHandler");
	      if (id) {
	        return this.trigger("post", this, id);
	      }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  var Resize;
	  return Resize = (function(_super) {
	    __extends(Resize, _super);
	
	    function Resize() {
	      console.log("Model -> Resize -> Constructor");
	      Resize.__super__.constructor.apply(this, arguments);
	    }
	    ...
	    Resize.prototype._events = function() {
	      return sn.__client__.models.image.on("select", (function(_this) {
	        return function(model, file) {
	          console.log("Model -> Resize -> Events -> select");
	          console.log(file);
	          return canvasResize(file, {
	            "width": _this._setting.CONFIG.RESIZE.WIDTH,
	            "height": _this._setting.CONFIG.RESIZE.HEIGHT,
	            crop: true,
	            callback: function(data, width, height) {
	              return sn.__client__.models.image.set({
	                "data": data,
	                "width": width,
	                "height": height
	              });
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Context = (function(_super) {
	    ...
	    Context.prototype.initialize = function() {
	      return console.log("Context -> Initialize");
	    };
	
	    Context.prototype._events = function() {
	      console.log("Context -> _events");
	      this.listenTo(sn.__client__.models.socket, "change:connected", this._changeConnectedHandler);
	      return this.listenTo(sn.__client__.models.socket, "failed", this._failedHandler);
	    };
	
	    Context.prototype.setup = function() {
	      console.log("Context -> Setup");
	      this._events();
	      return sn.__client__.models.socket.connect();
	    };
	    ...
	    Context.prototype._changeConnectedHandler = function(model, connected) {
	      ...
	      return sn.__client__.models.socket.join(this.get("roomid"), function(err, roomid) {
	        if (err) {
	          console.log(err);
	        }
	      });
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Visual = (function(_super) {
	    ...
	    Visual.prototype.initialize = function() {
	      return console.log("Visual -> Initialize");
	    };
	
	    Visual.prototype._events = function() {
	      console.log("Visual -> _events");
	      this.listenTo(sn.__client__.models.socket, "change:readText", this._changeReadTextHandler);
	      return this.listenTo(sn.__client__.models.socket, "change:readLightValue", this._changeReadLightValueHandler);
	    };
	    ...
	    Visual.prototype._changeReadTextHandler = function(model, data) {
	      console.log("Visual -> _changeReadTextHandler");
	      this.set("readText", data);
	      return this.trigger("changeText", this, data);
	    };
	
	    Visual.prototype._changeReadLightValueHandler = function(model, data) {
	      console.log("Visual -> _changeReadLightValueHandler");
	      this.set("readLightValue", data);
	      return this.trigger("changeLightValue", this, data);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Image = (function(_super) {
	    ...
	    Image.prototype.el = "#image";
	
	    Image.prototype.initialize = function() {
	      console.log("View | Image -> initialize");
	      this.model = sn.__client__.models.image;
	      this.listenTo(this.model, "select", this._selectHandler);
	      this.listenTo(this.model, "post", this._postHandler);
	      return this.listenTo(sn.__client__.models.deviceSensor, "throw", this._throwHandler);
	    };
	
	    Image.prototype._selectHandler = function() {
	      return console.log("View | Image -> _selectHandler");
	    };
	
	    Image.prototype._postHandler = function(model, id) {
	      var $imageHolder, imageHeight, imageWidth, isLandscape, originalImageHeight, originalImageWidth, parentHeight, parentWidth, r, rx, ry;
	      ...
	      $imageHolder.find(".image-holder-load-img").addClass("is-hidden");
	      return $imageHolder.find(".image-holder-label").removeClass("is-hidden");
	    };
	
	    Image.prototype._throwHandler = function() {
	      console.log("View | Image -> _throwHandler");
	      return this._clear();
	    };
	
	    Image.prototype._fly = function(callback, context) {
	      return console.log("View | Image -> _fly");
	    };
	
	    Image.prototype._clear = function(callback, context) {
	      var $imageHolder;
	      console.log("View | Image -> _clear");
	      $imageHolder = $("#js-image-holder");
	      $imageHolder.find(".image-body").removeAttr("src");
	      $imageHolder.find(".image-holder-load-img").removeClass("is-hidden");
	      return $imageHolder.find(".image-holder-label").addClass("is-hidden");
	    };
	
	    Image.prototype._restore = function() {
	      return console.log("View | Image -> _restore");
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Image = (function(_super) {
	    ...
	    Image.prototype.el = ".image-select";
	    ...
	    Image.prototype.initialize = function() {
	      ...
	      this.listenTo(sn.__client__.models.image, "select", this._selectHandler);
	      return this.listenTo(sn.__client__.models.image, "clear", this._clearHandler);
	    };
	
	    Image.prototype._pointerdown = function() {
	      console.log("View | Select -> _pointerdown");
	      return this.$el.addClass("highlighted");
	    };
	
	    Image.prototype._pointercancel = function() {
	      console.log("View | Select -> _pointercancel");
	      return this.$el.removeClass("highlighted");
	    };
	
	    Image.prototype._change = function(e) {
	      var file;
	      console.log("View | Select -> _change");
	      file = e.target.files[0];
	      return sn.__client__.models.image.set("file", file);
	    };
	    ...
	    Image.prototype._clearHandler = function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  var ReadText;
	  return ReadText = (function(_super) {
	    __extends(ReadText, _super);
	
	    function ReadText() {
	      console.log("View | ReadText -> Constructor");
	      ReadText.__super__.constructor.apply(this, arguments);
	    }
	
	    ReadText.prototype.el = "#js-read-text";
	
	    ReadText.prototype.initialize = function() {
	      console.log("View | ReadText -> initialize");
	      this.model = sn.__client__.models.visual;
	      return this.listenTo(this.model, "changeText", this._readTextHandler);
	    };
	
	    ReadText.prototype._readTextHandler = function(model) {
	      return this.$el.text(this.model.get("readText"));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  var ReadLightValue;
	  return ReadLightValue = (function(_super) {
	    __extends(ReadLightValue, _super);
	
	    function ReadLightValue() {
	      console.log("View | ReadLightValue -> Constructor");
	      ReadLightValue.__super__.constructor.apply(this, arguments);
	    }
	
	    ReadLightValue.prototype.el = "#js-read-light";
	
	    ReadLightValue.prototype.initialize = function() {
	      console.log("View | ReadLightValue -> initialize");
	      this.model = sn.__client__.models.visual;
	      return this.listenTo(this.model, "changeLightValue", this._readLightValueHandler);
	    };
	
	    ReadLightValue.prototype._readLightValueHandler = function(model) {
	      var to;
	      console.log(sn.tf.valueMap);
	      to = {
	        opacity: sn.tf.valueMap(parseInt(this.model.get("readLightValue")), 0, 100, 0, 1.0, false)
	      };
