...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery, _) {(function(window, document, $) {
	  ...
	  sn.router = (function() {
	    var Router;
	    Router = __webpack_require__(2)(sn, $, _);
	    return new Router();
	  })();
	  return $(window).load(function() {
	    ...
	    sn.tf.setup(function() {
	      ...
	      return $.when(sn.router.setup(), sn.stage.setup()).then((function(_this) {
	        return function() {
	  ...
	  Client = (function() {
	    ...
	    Client.prototype.setup = function() {
	      ...
	      for (key in sn.__client__.models) {
	        if (typeof (_base = sn.__client__.models[key]).setup === "function") {
	          _base.setup();
	        }
	      }
	      return console.log(canvasResize);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4), __webpack_require__(7), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Socket = (function(_super) {
	    ...
	    Socket.prototype._devicesensorThrowHandler = function(model, heading) {
	      console.log("Socket -> _devicesensorThrowHandler id: " + sn.__client__.models.image.id + " heading: " + heading);
	      if (!this._socket) {
	        return;
	      }
	      return this._socket.emit("trigger", {
	      ...
	      if (x > thres || y > thres || z > thres) {
	        if (!this.has("maxKey")) {
	          ...
	          if (this.get("maxVal" < maxVal)) {
	            ...
	            this.trigger("devicemotion", this);
	            this.unset("throwable");
	            return window.removeEventListener("devicemotion", this.devicemotionHandler, false);
	          }
	        }
	      } else {
	        this.unset("maxKey");
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Resize = (function(_super) {
	    ...
	    Resize.prototype.initialize = function() {
	      return console.log("Model -> Resize -> initialize");
	    };
	    ...
	    Resize.prototype._events = function() {
	      return sn.__client__.models.image.on("select", function(model, file) {
	        var fileReader;
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Image = (function(_super) {
	    ...
	    Image.prototype._postHandler = function(model, id) {
	      return console.log("View | Image -> _postHandler");
	    };
	
	    Image.prototype._throwHandler = function() {
	      return console.log("View | Image -> _throwHandler");
	    };
	    ...
	    Image.prototype._clear = function(callback, context) {
	      return console.log("View | Image -> _clear");
	    };
